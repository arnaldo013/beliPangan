...
import com.example.belipangan.activity.RequestEditDetailActivity;
import com.example.belipangan.model.Product;
import com.squareup.picasso.Picasso;

import java.util.LinkedList;

public class EditRequestAdapter extends RecyclerView.Adapter<EditRequestAdapter.PendingOrder> {
    private LinkedList<Product> list;
    private LayoutInflater iAdapter;

    public EditRequestAdapter(Context context, LinkedList<Product> list){
        this.list = list;
    ...
    public PendingOrder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = iAdapter.inflate(R.layout.adapter_edit_request, parent, false);
    ...
    public void onBindViewHolder(@NonNull PendingOrder holder, int position) {
        ...
        holder.tvBerat.setText(String.valueOf(berat) + "gr");
    ...
    public class PendingOrder extends RecyclerView.ViewHolder implements View.OnClickListener {
        EditRequestAdapter adapter;
        TextView tvNama, tvHarga, tvBerat;
        CardView cv;
        ImageView ivProduct;

        public PendingOrder(@NonNull View itemView, EditRequestAdapter adapter) {
            super(itemView);
        ...
        public void onClick(View view) {
            Intent intent = new Intent(view.getContext(), RequestEditDetailActivity.class);
